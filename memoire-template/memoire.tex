...
% Pour ajouter un mot d'explication sur la page de respect des règles éthiques.
% \charte{Generative AI was used in this work as a linguistic
%   assistant, providing support for the formulation and writing of this
%   document.}
